...
// h-6 w-10 (1.5rem/24px × 2.5rem/40px) creates proper pill shape with 1.67:1 ratio - narrower & taller
const TOGGLE_BASE_CLASSES = "relative inline-flex h-6 w-10 flex-shrink-0 items-center rounded-full transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 focus:ring-offset-zinc-900";
const TOGGLE_PIN_CLASSES = "inline-block h-5 w-5 rounded-full bg-white transition-transform duration-200";
