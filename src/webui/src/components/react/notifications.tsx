...
// Mobile: h-5 w-8 (1.25rem/20px × 2rem/32px) matches desktop proportions with 1.6:1 ratio
// Desktop: h-8 w-13 (2rem/32px × 3.25rem/52px) creates iOS-style pill shape with 1.625:1 ratio
const TOGGLE_BASE_CLASSES = "relative inline-flex h-5 w-8 sm:h-8 sm:w-13 flex-shrink-0 items-center rounded-full transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 focus:ring-offset-zinc-900";
const TOGGLE_PIN_CLASSES = "inline-block h-4 w-4 sm:h-7 sm:w-7 rounded-full bg-white transition-transform duration-200";
